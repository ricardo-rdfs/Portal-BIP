...
<label for="clean_all_10" ><span id="redX" onMouseOver="mano(this);" class="heading">x</span> </label> <b> Limpiar filtros</b> <input type="checkbox" class="checkbox" name="clean_all_10" id="clean_all_10" style="display: none;" /> 					
