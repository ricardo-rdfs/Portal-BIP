...
<label for="clean_all_10" ><p onMouseOver="mano(this);" class="heading"><span id="redX">x</span></p> </label> <b> Limpiar filtros</b> <input type="checkbox" class="checkbox" name="clean_all_10" id="clean_all_10" style="display: none;" /> 					
