...
<link href='".__PS_BASE_URI__."css/jquery.fancybox-1.3.4.css' rel='stylesheet' type='text/css' media='screen' />";
		...
		echo '		</td>
				...
				if ($postAccessories = Tools::getValue('inputAccessories'))
				{
					...
					INNER JOIN '._DB_PREFIX_.'product p ON (ct.id_category = p.id_category_default)
...
';
foreach($categories as $SubCat){
echo "<a class='extLink_".$SubCat[0]."' href='".__PS_BASE_URI__."modules/blockconfigurador_wmin/categorias.php?content_only=1&noredirect=1&id_category=".$SubCat[0]."' id='linkExterno_".$SubCat[0]."'></a>";
